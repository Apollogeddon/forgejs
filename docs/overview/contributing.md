...
> **Editor Setup:** This project utilises a `.editorconfig` file. Ensure the IDE is configured to respect these settings (indentation, line endings, etc.) to maintain consistency across the codebase.
